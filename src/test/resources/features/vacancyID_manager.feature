Feature: Vacancy ID Page - Department Manager
  ...
  @all @smoke @vacancyid @test @auto-test-manager@onyx.com
  Scenario: Vacancy ID Page Appeared
    ...
    Then Select User 'zorgan' In User Field in Vacancy ID Page
    Then Click 'Send' Button in Vacancy ID Page